          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background: `radial-gradient(100px circle at ${cursorPosition.x}px ${cursorPosition.y}px, #004ac087, #06eb7925)`,
              }}
            />
            <TiLocationArrow className="relative z-20" />
            <p className="relative z-20">TalkToUs</p>
          </div>
        )}
      </div>
    </div>
    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-green-400 opacity-50">
          ...
          True luxury is a state of being.
        </p>
      </div>
      ...
      <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
        <BentoCard
          ...
          title={
            <div className="bento-title special-font">Minding<b> Your little ones</b>
            </div>
          }
          description="Medi0ne services"
          TalkToUs
        />
      </BentoTilt>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <BentoCard
            ...
            title={
              <>
                Keep<b> your family</b> healthy
              </>
            }
            description="Giving your children the best start in life."
            TalkToUs
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            ...
            description="We offer a wide range of skin care products and services and advice on skin care"
            TalkToUs
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            description="Helping you to improve your natural beauty and health."
            ReachOut
          />
        </BentoTilt>
